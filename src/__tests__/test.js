...
describe('test xSampling', () => {
  ...
  it('case when we sample within a specific range with log distribution', () => {
  ...
  it('case when we sample within a specific range with uniform distribution and include end point', () => {
    let result = xSampling({
      startPoint: 1,
      endPoint: 100,
      nbPoints: 10,
  ...
  it('case when we sample within a specific range with uniform distribution and do not include end point', () => {
    let result = xSampling({
      startPoint: 1,
      endPoint: 100,
      nbPoints: 10,
